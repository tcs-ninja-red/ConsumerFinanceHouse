...
export class QuoteForm extends Component {
    constructor() {
        ...
        this.state = {
            ...
            mileageList: ["5000", "10000", "15000", "20000", "25000", "30000", "35000", "40000", "45000",],
            postCode: "",
        }
                ...
                <div className="quotes-container">
                        ...
                        <div className="columns">
                            <div className="column">
                                <div className="columns">
                                    <div className="column">
                                        <strong>Make : </strong>
                                        <span> {this.state.makeVal} </span>
                                    </div>
                                    <div className="column">
                                        <strong>Model : </strong>
                                        <span> {this.state.modelVal} </span>
                                    </div>
                                    <div className="column">
                                        <strong>Description : </strong>
                                        <span> {this.state.descVal} </span>
                                    </div>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-sm">
                            <div className="form-group">
                                <strong>Term:</strong>
                                <select className="form-control" onChange={this.handleChangeMake}>
                    ...
                    <div className="level">
                        <div className="level-item has-text-centered">
                            ...
                            <button
                                onClick={() =>
                                    this.props.getVehicleQuotes(this.state.Product, this.state.cash_price)
                                }
                                ...
                                <div className="columns">
                                    <div className="column is-three-fifths is-offset-one-fifth">
                                        <div className="columns">
                                            ...
                                            <div className="column">
                                                <span> {QuoteState.QuoteResults.monthly_payment_amount} </span>
